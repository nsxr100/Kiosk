...
class _EwalletState extends State<Ewallet> {
  ...
  String phone(){return '+63${digits()}';}
  bool validPhone(){final d=digits();return d.length==10&&d.startsWith('9');}
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text(tr(widget.lang,'ewallet')),),
      body: ListView(padding: EdgeInsets.all(18),children: [
        ...
        SizedBox(height: 14,),
        TextField(controller: mobile,keyboardType: TextInputType.number,inputFormatters: [FilteringTextInputFormatter.digitsOnly,LengthLimitingTextInputFormatter(10)],decoration: InputDecoration(labelText: tr(widget.lang,'mobile_number'),border: OutlineInputBorder(),prefixText: '+63 ',helperText: 'Example: 9123456789',),),
        SizedBox(height: 14,),
