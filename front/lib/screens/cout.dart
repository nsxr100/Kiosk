...
class _CoutState extends State<Cout> {
  ...
  bool loading=false;
  @override void initState(){super.initState();cart=Map<int,Menui>.from(widget.cart);qty=Map<int,int>.from(widget.qty);}
